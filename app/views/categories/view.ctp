...
<div class="main-col" id="content">
	<div class="main-col-inner">
		...
		<div class="content-header">
			<h3><?php echo $category_data['Category']['Description']; ?></h3>
        ...
        <button id="delete-offers" title="delete offers" type="button" class="scalable delete" onclick="submitDeleteForm('DeleteOffersForm');">
          <span><span><span>Delete Offers</span></span></span>
        </button>
        <button id="delete-category" title="delete category" type="button" class="scalable delete" onclick="submitDeleteForm('DeleteCategoryForm');">
          <span><span><span>Delete Category</span></span></span>
        </button>            				
			</p>
		</div>
		<form enctype="multipart/form-data" method="post" id="DeleteCategoryForm" action="/cmsv3/categories/delete">
		<input type="hidden" name="data[Category][CategoryCode]" id="hiddenID" value="<?php  echo $category_data['Category']['CategoryCode']; ?>" />		
    </form>		
		<form enctype="multipart/form-data" method="post" id="CategoryEditForm" action="/cmsv3/categories/edit">
							 ...
							 <table cellspacing="0" class="form-list">
								  <tbody>
									<tr>
										...
										<td class="value"><input id="CategoryCode" name="data[Category][CategoryCode]" class="input-text" type="text" value="<?php echo $category_data['Category']['CategoryCode']; ?>"/></td>
									</tr>
									<tr>
										<td class="label"><label for="Description">Description<span class="required">*</span></label></td>
										<td class="value"><input id="Description" name="data[Category][Description]" class="input-text" type="text" value="<?php echo $category_data['Category']['Description']; ?>"/></td>
									</tr>
									<tr>
										<td class="label"><label for="Slug">Slug<span class="required">*</span></label></td>
										<td class="value"><input id="Slug" name="data[Category][slug]" class="input-text" type="text" value="<?php echo $category_data['Category']['slug']; ?>"/></td>
									</tr>
									<tr>
										<td class="label"><label for="DisplayOrder">Display Order<span class="required">*</span></label></td>
										<td class="value"><input id="DisplayOrder" name="data[Category][DisplayOrder]" class="input-text" type="text" value="<?php echo $category_data['Category']['DisplayOrder']; ?>"/></td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td class="value"><?php echo $form->input('Category.ParentCategoryCode',array('type'=>'select','label'=>'','empty'=>'NONE', 'class'=>'required-entry select' ,'options'=>$ParentCategoryCodes,'value'=>$category_data['Category']['ParentCategoryCode'])); ?></td>
									</tr>
									<tr>
										<td class="label"><label for="category_type_id">Type</label></td>
										<td class="value"><?php echo $form->input('Category.category_type_id',array('type'=>'select','label'=>'','empty'=>'NONE', 'class'=>'required-entry select' ,'options'=>$CategoryTypes,'value'=>$category_data['Category']['category_type_id'])); ?></td>
									</tr>
									<tr>
									   <td colspan="2"><div class="spacer"><br /></div></td>
									</tr>
									<tr>
										...
										<td class="value"><input id="status_codes" name="data[Category][status_codes]" class="input-text" type="text" value="<?php echo $category_data['Category']['status_codes']; ?>"/></td>
									</tr>
									<tr>
										<td class="label"><label for="substatus_codes">SubStatus Codes</label></td>
										<td class="value"><input id="substatus_codes" name="data[Category][substatus_codes]" class="input-text" type="text" value="<?php echo $category_data['Category']['substatus_codes']; ?>"/></td>
									</tr>
									<tr>
								 ...
								 <tr>
										...
										<td class="value"><textarea id="Narrative" name="data[Category][Narrative]" class="input-text"><?php echo $category_data['Category']['Narrative']; ?></textarea></td>
									</tr>
								  </tbody>
								</table>
							</div>
							 ...
							 <table cellspacing="0" class="form-list">
								  <tbody>
									 <tr>
										  ...
										  <td class="value"><input id="LayoutTitle" name="data[Category][LayoutTitle]" class="input-text" type="text" value="<?php echo $category_data['Category']['LayoutTitle']; ?>"/></td>
									 </tr>
									 <tr>
										  <td class="label"><label for="CategoryH1">Category H1 Tag</label></td>
										  <td class="value"><input id="CategoryH1" name="data[Category][CategoryH1]" class="input-text" type="text" value="<?php echo $category_data['Category']['CategoryH1']; ?>"/></td>
									 </tr>
									 <tr>
										  <td class="label"><label for="LayoutMetaTags">META Tags</label></td>
										  <td class="value"><input id="LayoutMetaTags" name="data[Category][LayoutMetaTags]" class="input-text" type="text" value="<?php echo $category_data['Category']['LayoutMetaTags']; ?>"/></td>
									 </tr>
								   <tr>
										<td class="label"><label for="LayoutMetaDescription">META Description</label></td>
										<td class="value"><textarea id="LayoutMetaDescription" name="data[Category][LayoutMetaDescription]" class="input-text"><?php echo $category_data['Category']['LayoutMetaDescription']; ?></textarea></td>
									 </tr>
								  </tbody>
							  </table>
						  </div>
							 ...
							 <table cellspacing="0" class="form-list">
								  <tbody>
								   <tr>
										...
										<td class="value"><textarea id="CatHead" name="data[Category][CatHead]" class="input-text"><?php echo $category_data['Category']['CatHead']; ?></textarea></td>
									 </tr>
									 <tr>
